...
一个 **开箱即用的 Python 个人博客系统**：支持网页版（浏览器访问）与桌面版（窗口化运行、系统托盘），自带文章管理、Markdown 写作、评论点赞、归档标签、友链、Gitee 同步/新手向导、多用户支持等完整功能。本仓库同时收录了配套的 **零基础全流程学习教程**（含 4 篇主文档 + 12 个技术栈库详解 + 24 份独立库教程 + 两个离线教程网站）。
...
└── 博客教程/                     # 配套学习教程
    ...
    ├── 独立版库教程/              # 24 份「从小白到大神」独立库教程（Playwright / Django / Pandas 等）
    ├── 博客教程站_博客专版/       # 离线教程网站（双击 index.html 即用）
    └── 纯教程网站/               # 24 库离线教程网站（含教程生成器）
```
...
| `独立版库教程/` | 想全面掌握 Python 库的人 | 24 份「从小白到大神」全套教程（含进阶 + 项目案例） |
| `博客教程站_博客专版/index.html` | 喜欢网页阅读的人 | 离线教程网站，双击即用，支持日间/夜间模式 |
| `纯教程网站/index.html` | 喜欢网页阅读的人 | 24 库离线教程站，带「教程生成器」 |
